  ...
  <header>
    <nav class="navbar navbar-expand-lg mr-5 ml-5">
      ...
      <div class="collapse navbar-collapse" id="menu">
        ...
        <form class="form-inline my-2 my-lg-0" name="formBusca" action="index.php?pagina=busca">
          	<input class="form-control mr-sm-2" type="search" placeholder="Digite para buscar..." aria-label="Busque">
