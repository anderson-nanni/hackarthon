<?php
	...
	$sql = "SELECT tipov FROM tipov WHERE idtipov = ".(int)$id." limit 1";
	$result = mysqli_query($con, $sql);
	$dados = mysqli_fetch_array( $result );
?>
<div class="container">
	<h2 class="mt-5">Categoria: <?=$dados['tipov']?></h2>

<div class="row mt-3">
	<?php

		//selecionar 6 produtos - rand -> sorteio - limit limitar o nr de resultado
		$sql = "SELECT * FROM veiculo INNER JOIN tipov ON veiculo.tipo = tipov.tipov INNER JOIN marca ON veiculo.marca_id = marca.idmarca WHERE tipov.idtipov = ".(int)$id;
